...
export function PostHogProvider({ children, user }: { children: React.ReactNode; user: SessionUser | null }) {
  ...
  //
  // posthog-js is imported here rather than at module scope so it loads after
  // the page is interactive instead of blocking it. This is also what warms
  // the module for `capture()` calls elsewhere.
  useEffect(() => {
