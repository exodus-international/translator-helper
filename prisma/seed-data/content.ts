// ---------------------------------------------------------------------------
// Markdown content for seed document versions, keyed by document slug prefix.
// Split out of seed.ts so the seeding logic stays readable.
// ---------------------------------------------------------------------------
...
export const CONTENT_BY_LANGUAGE: Record<string, Record<string, string>> = {
  cs: CZECH_CONTENT,
  sk: SLOVAK_CONTENT,
  hr: CROATIAN_CONTENT,
  de: GERMAN_CONTENT,
